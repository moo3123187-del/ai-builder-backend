...
- Use 6-10 objects for anything more complex than a single simple item. Build a genuinely complete, recognizable structure -- all major walls/sections/features -- never just one block. Stay concise: this has a strict output budget, so do not exceed 10 objects.
- To save space, OMIT the "meshType" and "light" keys entirely on any object that doesn't need them -- do not write them as null, just leave them out.
